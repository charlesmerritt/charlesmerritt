...
My thesis project! It's all about creating a digital twin of the forest to better capture random events like storms, fires, or pests, and then training an agent on that environment using deep reinforcement learning.
